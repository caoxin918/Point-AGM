...
class ModelNet10Ply2048(Dataset):
    def __init__(
        self,
        root,
        split="train",
        ...
        self.data_list = []
        self.labels_list = []
        for h5_name in glob.glob(os.path.join(root, "%s*.h5" % split)):
...
class ModelNet10Ply2048DataModule(pl.LightningDataModule):
    """
    size: 12308
    train: 9840
    test: 2468
    ...
    def __init__(
        self,
        data_dir: str = "./data/modelnet10_hdf5_2048",
        batch_size: int = 32,
        drop_last: bool = True,
    ):
        super().__init__()
    ...
    def setup(self, stage: Optional[str] = None):
        self.modelnet_train = ModelNet10Ply2048(self.hparams.data_dir, split="train")  # type: ignore
        self.modelnet_test = ModelNet10Ply2048(self.hparams.data_dir, split="test")  # type: ignore
